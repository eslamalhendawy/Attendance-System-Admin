...
const NewCourseData = () => {
  ...
  return (
    <section className="grow">
      ...
      <p className="xl:w-[40%] mx-auto font-medium text-xl mb-6">Doctor: {newCourse.doctorId.name}</p>
      ...
      <div className="flex flex-wrap gap-4 mb-[180px] xl:w-[40%] mx-auto">
        ...
        {newCourse.prerequisites.length === 0 && <p className="text-red-500 text-lg">No Prerequisites Found</p>}
      </div>
