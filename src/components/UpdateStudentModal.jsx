    ...
    return (
        <>
            <button
                ...
                className="bg-accent hover:bg-primary duration-300 text-white py-4 w-[150px] rounded-lg text-xl capitalize"
            >
                update Data
            </button>
                            ...
                            <>
                                ...
                                <div className="flex flex-col items-center gap-3 mb-4">
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <input
                                            ...
                                            type="text"
                                            id="name"
                                            className="border-2 border-black p-1 outline-none placeholder:text-black w-[250px]"
                                        />
                                    </div>
                                    <div className="flex flex-col gap-2">
                                        <label htmlFor="name" className="text-lg font-semibold">
                                ...
                                <div className="flex flex-col items-center gap-3 mb-4">
                                    <div className="flex flex-col gap-2">
                                        ...
                                        <Select
                                            onChange={(e) => setPassedCourses(e.map((course) => course.value))}
                                            styles={customStyles}
                                            options={coursesList}
                                            isMulti
                                            placeholder=""
                                ...
                                <div className="flex items-center justify-end gap-4">
                                    <button
                                        ...
                                        className="py-2 w-[100px] bg-accent hover:bg-primary duration-200 rounded-lg text-white"
                                    >
                                        Cancel
                                    </button>
                                    <button
